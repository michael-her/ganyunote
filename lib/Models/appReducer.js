...
import { ADD_CHAR, SELECT_CHAR, UPDATE_CHAR, UPDATE_TALENT, CHANGE_WEAPON, CHANGE_ARTIFACT, CHANGE_ARTIFACT_STAT } from './actions'
...
export default (state = {}, action) => {
  switch(action.type) {
    ...
    case CHANGE_ARTIFACT:
      return update(state, {character: {[action.charName]: {
        setting: {artifact: {$set: action.artifact}, artifactSub: {$set: action.artifactSub}},
        talents: {
