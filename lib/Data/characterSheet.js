      ...
      skills: {
        ...
        elementalBurst: {
          ...
          'elementalBurstStance$_burstAddition%': {$set: {
            passive: true,
            amount(char) {
              return char.talents.skills.elementalBurst.resolveStacks.stacks *
                skillLvSheet.raiden.elementalBurstHit['burstAddition%'][char.setting.burstLv]
            }
          }},
          'elementalBurstStance$_normalAttacksAddition%': {$set: {
            ...
            amount(char) {
              return char.talents.skills.elementalBurst.resolveStacks.stacks *
                skillLvSheet.raiden.elementalBurstHit['normalAttacksAddition%'][char.setting.burstLv]
            }
          }}
        },
      },
