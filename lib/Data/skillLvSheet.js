...
const skillLvSheet = {
  ...
  zhongli: {
    hit1: {
      multiplier:
        [30.77, 33.27, 35.78, 39.36, 41.86, 44.72, 48.66, 52.59, 56.53, 60.82, 65.74, 71.53, 77.31, 83.1, 89.41],
      elemental: false,
    },
    hit2: {
      multiplier:
        [31.15, 33.69, 36.22, 39.85, 42.38, 45.28, 49.26, 53.25, 57.23, 61.58, 66.56, 72.42, 78.27, 84.13, 90.52],
      elemental: false,
    },
    hit3: {
      multiplier:
        [38.58, 41.72, 44.86, 49.34, 52.48, 56.07, 61, 65.94, 70.87, 76.26, 82.42, 89.68, 96.93, 104.18, 112.1],
      elemental: false,
    },
    hit4: {
      multiplier:
        [42.94, 46.43, 49.93, 54.92, 58.42, 62.41, 67.9, 73.4, 78.89, 84.88, 91.74, 99.82, 107.89, 115.97, 124.77],
      elemental: false,
    },
    hit5: {
      multiplier:
        [10.75, 11.63, 12.5, 13.75, 14.63, 15.63, 17, 18.38, 19.75, 21.25, 22.97, 24.99, 27.01, 29.03, 31.24],
      count: 4,
      elemental: false,
    },
    hit6: {
    ...
    chargedAttack: {
      multiplier:
        [111.03, 120.06, 129.1, 142.01, 151.05, 161.38, 175.58, 189.78, 203.98, 219.47, 237.22, 258.1, 278.97, 299.85, 322.62],
      stamina: 25,
      elemental: false,
    },
    plungeAttack: {
      multiplier:
        [159.68, 172.67, 185.67, 204.24, 217.23, 232.09, 252.51, 272.93, 293.36, 315.64, 337.92, 360.2, 382.48, 404.76, 427.04],
      elemental: false,
    },
    elementalSkillClick: {
      multiplier:
        [16, 17.2, 18.4, 20, 21.2, 22.4, 24, 25.6, 27.2, 28.8, 30.4, 32, 34, 36, 38],
      cd: 4,
    },
    elementalSkillHold: {
      multiplier:
        [80, 86, 92, 100, 106, 112, 120, 128, 136, 144, 152, 160, 170, 180, 190],
      cd: 12,
    },
    elementalSkillTick: {
      multiplier:
        [32, 34.4, 36.8, 40, 42.4, 44.8, 48, 51.2, 54.4, 57.6, 60, 64, 68, 72, 76],
      interval: 2,
      duration: 20,
    },
    elementalSkillShield: {
      shield:
        [1232, 1356, 1489, 1633, 1787, 1951, 2126, 2311, 2506, 2712, 2927, 3153, 3389, 3636, 3893],
      'maxHpToShield%':
        [12.8, 13.76, 14.72, 16, 16.96, 17.92, 19.2, 20.48, 21.76, 23.04, 24.32, 25.6, 27.2, 28.8, 30.4],
      duration: 20,
    },
    elementalBurstHit: {
      multiplier:
        [401.08, 444.44, 487.8, 542, 590.78, 649.56, 704.6, 769.84, 834.68, 899.72, 964.76, 1029.8, 1084, 1138.2, 1192.4],
      cd: 12,
      cost: 40,
    },
    elementalBurstCurse: {
      duration:
        [3.1, 3.2, 3.3, 3.4, 3.5, 3.6, 3.7, 3.8, 3.9, 4, 4, 4, 4, 4, 4],
      cd: 12,
      cost: 40,
    },
    elementalBurstShield: {
      shield:
        [1232, 1356, 1489, 1633, 1787, 1951, 2126, 2311, 2506, 2712, 2927, 3153, 3389, 3636, 3893],
      'maxHpToShield%':
        [12.8, 13.76, 14.72, 16, 16.96, 17.92, 19.2, 20.48, 21.76, 23.04, 24.32, 25.6, 27.2, 28.8, 30.4],
  ...
  kokomi: {
    hit1: {
      multiplier:
        [68.38, 73.5, 78.63, 85.47, 90.6, 95.73, 102.56, 109.4, 116.24, 123.08, 129.91, 136.75, 145.3, 153.85, 162.39],
    },
    hit2: {
      multiplier:
        [61.54, 66.15, 70.77, 76.92, 81.54, 86.15, 92.31, 98.46, 104.62, 110.77, 116.92, 123.08, 130.77, 138.46, 146.15],
    },
    hit3: {
      multiplier:
        [94.31, 101.38, 108.45, 117.88, 124.95, 132.03, 141.46, 150.89, 160.32, 169.75, 179.18, 188.61, 200.4, 212.19, 223.98],
    },
    chargedAttack: {
      multiplier:
        [148.32, 159.44, 170.57, 185.4, 196.52, 207.65, 222.48, 237.31, 252.14, 266.98, 281.81, 296.64, 315.18, 333.72, 352.26],
      stamina: 50,
    },
    plungeAttack: {
      multiplier:
        [141.93, 153.49, 165.04, 181.54, 193.1, 206.3, 224.45, 242.61, 260.76, 280.57, 300.37, 320.18, 339.98, 359.79, 379.59],
      elemental: false,
    },
    elementalSkillTick: {
      multiplier:
        [109.19, 117.38, 125.57, 136.49, 144.68, 152.87, 163.79, 174.7, 185.62, 196.54, 207.46, 218.38, 232.03, 245.68, 259.33],
      duration: 12,
      interval: 2,
      icd: 2.5,
      cd: 20,
    ...
    elementalSkillHeal: {
      passive: true,
      amount(char) { return this['heal%'][calcSkillLv(char)] + this.heal[calcSkillLv(char)] },
      'heal%':
        [4.4, 4.73, 5.06, 5.5, 5.83, 6.16, 6.6, 7.04, 7.48, 7.92, 8.36, 8.8, 9.35, 9.9, 10.45],
      heal:
        [424, 466, 512, 561, 614, 671, 731, 795, 862, 932, 1006, 1084, 1165, 1250, 1338],
      duration: 12,
      interval: 2,
      cd: 20,
    },
    elementalBurstHit: {
      multiplier:
        [10.42, 11.2, 11.98, 13.02, 13.8, 14.58, 15.62, 16.67, 17.71, 18.75, 19.79, 20.83, 22.13, 23.44, 24.74],
      duration: 10,
      cd: 18,
      cost: 70,
    }
