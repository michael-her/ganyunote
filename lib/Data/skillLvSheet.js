  ...
  raiden: {
    ...
    elementalBurstHit: {
      multiplier:
        [127.2, 136.74, 146.28, 159, 168.54, 178.08, 190.8, 203.52, 216.24, 228.96, 241.68, 254.4, 270.3, 286.2, 302.1],
	  'burstAddition%':
		[3.89, 4.18, 4.47, 4.86, 5.15, 5.44, 5.83, 6.22, 6.61, 7,    7.39, 7.78, 8.26, 8.75, 9.23],
	  'normalAttacksAddition%':
		[0.73, 0.78, 0.84, 0.91, 0.96, 1.02, 1.09, 1.16, 1.23, 1.31, 1.38, 1.45, 1.54, 1.63, 1.72],
      cd: 18,
      cost: 90,
    }
  }
